...
def compute_severity_scores(df):
    ...
    try:
        ...
        if pd.isna(max_fatalities):
            print("⚠️ All 'fatalities' values could not be converted to numeric.")
        ...
        print("❌ Error normalizing fatalities:", e)
        print("Problematic 'fatalities' column:")
        print(df['fatalities'].head())
        raise
